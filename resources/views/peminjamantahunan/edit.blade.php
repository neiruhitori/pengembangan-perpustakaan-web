                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="jam_pinjam" class="form-control" value="{{ $peminjamantahunan->jam_pinjam }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tanggal Kembali</label>
                                        <input type="date" name="jam_kembali" class="form-control" value="{{ $peminjamantahunan->jam_kembali }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="book-list">
                                <h4>Daftar Buku</h4>
                                @foreach ($peminjamantahunan->bukus as $index => $selectedBuku)
                                <div class="book-row">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Buku {{ $index + 1 }}:</label>
                                                <select name="bukucruds_id[]" class="form-control select2-books" required>
                                                    ...
                                                    @foreach ($bukucrud as $bc)
                                                        <option value="{{ $bc->id }}"
                                                            ...
                                                            @if ($bc->stok <= 0 && $bc->id != $selectedBuku->bukucruds_id) disabled @endif>
                                                            {{ $bc->buku }} @if ($bc->stok <= 0 && $bc->id != $selectedBuku->bukucruds_id)
                                                                (Stok Habis)
                                                            @endif
                                                        </option>
                                                    @endforeach
